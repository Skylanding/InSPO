#!/bin/bash
# SimPO Instruct Setup - Quick test (100 prompts)
...
echo "   Test scale: 100 prompts"
echo "   Seeds: ${SEEDS[@]}"
echo "   Expected output: ~500 preference pairs"
echo ""
...
echo "=========================================="
echo "📌 Generating 5 responses for 100 prompts"
echo "📌 Estimated time: ~10-15 min per seed"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "$OUTPUT_DIR/ultrafeedback_test_dpo.jsonl" ]; then
        echo "📊 DPO data: $(wc -l < $OUTPUT_DIR/ultrafeedback_test_dpo.jsonl) preference pairs"
    fi
else
...
echo "=========================================="
echo "📁 Output files:"
echo "   SimPO data: $OUTPUT_DIR/ultrafeedback_test_simpo.json"
echo "   DPO data: $OUTPUT_DIR/ultrafeedback_test_dpo.jsonl"
echo ""

# Show result statistics
if [ -f "$OUTPUT_DIR/ultrafeedback_test_dpo.jsonl" ]; then
    echo "📊 Final stats:"
    echo "   DPO preference pairs: $(wc -l < $OUTPUT_DIR/ultrafeedback_test_dpo.jsonl)"
    echo ""
...
echo "✅ Quick test complete! If results look good, run the full version."
